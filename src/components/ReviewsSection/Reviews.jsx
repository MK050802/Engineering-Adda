...
//   return (
//     <div className="h-screen bg-sky-600 text-white flex items-center justify-center">
...
//         <Swiper
//           spaceBetween={80}
//           slidesPerView={4} // aree ye chhota bada hi aayega
                ...
                >
                  <div className="logo">
                    {lang.photo ? (
                      ...
                      <FaUserAlt className="text-5xl text-gray-500" />
                    )}
                  </div>
                  <h2 className="text-3xl mt-2 font-semibold">{lang.name}</h2>
                  <p className="para">
